		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<div class="baBody">
					...
					<div class="bbD">
						商品价钱：<input type="text" class="input3" name="goods_price" />
					</div>
					<div class="bbD">
						商品库存：<input type="text" class="input3" name="goods_number" />
					</div>
					<div>
						商品推荐：<input type="checkbox"  name="is_recommend" value="1" />推荐
						<input type="checkbox"  name="is_boutique" value="1" />精品
						<input type="checkbox"  name="is_special" value="1" />特价
					</div>
					<div class="bbD">
						是否显示：
						<label>
							<input type="radio" checked="checked" name="is_show" value="1" />&nbsp;是
						</label>
						<label>
